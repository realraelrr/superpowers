...
mkdir -p src test .state/plans

# Create a simple implementation plan
cat > .state/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at .state/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at .state/plans/implementation-plan.md using the subagent-driven-development skill.
